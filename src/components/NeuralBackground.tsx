...
/**
 * NeuralBackground — An interactive SVG particle grid that simulates
 * a neural network / structural mesh. As the mouse moves, the nearest
 * dots connect with glowing green/blue lines.
 */
